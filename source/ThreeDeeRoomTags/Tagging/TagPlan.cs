namespace ThreeDeeRoomTags.Tagging
{
    ...
    ///
    /// Plain doubles rather than Revit's XYZ so that planning can be tested without a running
    /// Revit. The link transform, when there is one, is applied on the way in.
    /// </summary>
    internal readonly struct TagPoint
    {
    ...
    /// <summary>
    /// Everything the planner needs to know about one room or space, read out of the model
    /// before any decision is made.
    /// </summary>
    internal sealed class SpatialElementSnapshot
    {
        ...
        /// <summary>
        /// Zero for a room that is unbounded, redundant or unplaced. Carried so the dialog and
        /// the planner can agree on one definition of "taggable" rather than counting
    ...
    internal sealed class ExistingTagSnapshot
    {
    ...
    internal sealed class TagOperation
    {
